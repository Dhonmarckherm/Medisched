    ...
    <div className="min-h-screen" style={{ background: "#f5f8fb" }}>
      ...
      <main className="pt-[100px] pb-10 w-[90%] max-w-[1200px] mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          {!isAdminOrNurse && (
            <Link href="/certificates/new" className="bg-primary text-white rounded-lg px-4 py-1.5 text-[13px] font-medium no-underline hover:bg-primary-hover hover:-translate-y-0.5 hover:shadow-lg transition">
              + New Request
            </Link>
          )}
        </div>

        <CertificatesListClient certificates={certificates || []} isAdminOrNurse={isAdminOrNurse} />
      </main>
    </div>
  );
}
